...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The first is an invisible profile. This is not a college problem anymore. The students showing up to freshman year with a fully built LinkedIn profile, a clear positioning statement, and two or three real professional relationships already in place are starting the race at a different line than everyone else. Junior and senior year of high school is not too early. For the most competitive programs, it may already be late. A LinkedIn page with a headshot and a class year is not a profile. It is a placeholder. LinkedIn's algorithm prioritizes semantic relevance, looking for skill clusters across a student's headline, about section, and experience, not just a job title in the bio. A recruiter running a search for a summer finance analyst intern does not find the student with the incomplete profile. They find the one who built theirs to be found. Most students have not done that work, and no one has shown them how.",
