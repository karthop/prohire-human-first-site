    ...
    <ServiceTemplate
      ...
      capabilities={[
        ...
        },
        {
          ...
          body: "Structured advisory for founders post-exit and CXOs post-transaction on the next chapter: operator, investor, advisor, or board portfolio. For company-side outplacement and workforce transitions handled with the same care, see HR Support & Advisory.",
        },
      ]}
      disciplines={[
        {
