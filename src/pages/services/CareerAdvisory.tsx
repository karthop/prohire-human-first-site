    ...
    <ServiceTemplate
      ...
      capabilities={[
        ...
        },
        {
          ...
          body: "Structured advisory for founders post-exit and CXOs post-transaction on the next chapter: operator, investor, advisor, or board portfolio. For company-side outplacement and workforce transitions handled with the same care, see HR & Talent Leadership Support.",
        },
      ]}
      disciplines={[
        {
      ...
      engagementsNote="Investment is engagement-specific and discussed in consultation. Senior advisory work is fixed-fee, structured, and scoped to a written engagement, never hourly."
      faq={[
        {
